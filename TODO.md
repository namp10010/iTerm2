...
34. [ ] when restoring app from shutdown (Cmd + Q), the group status are not restored. for example, folded and unfolded group are not restored. also, active tab is not also restore (double check)

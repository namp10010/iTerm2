...
38. [ ] when open the web browser tab, it has separate color theme and it override existing profile one. I tried to set it up so that it's consistent with the main profile I use but it stay the same (dark theme, with dark background for the tab bar). how to fix this?

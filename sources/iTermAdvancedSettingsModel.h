...
+ (BOOL)preloadWebBrowserEngine;
+ (void)setPreloadWebBrowserEngine:(BOOL)value;
+ (BOOL)acceptOSC7;
...
+ (int)claudeGracefulExitInitialDelayMS;
+ (NSString *)claudeGracefulExitProcessNames;
+ (NSString *)claudeGracefulExitSequenceHex;
+ (BOOL)claudeGracefulExitSystemShutdownOnly;
+ (double)claudeGracefulExitTimeoutSeconds;
...
+ (double)gitTimeout;
+ (BOOL)gracefullyExitClaudeOnQuit;
+ (BOOL)hdrCursor;
...
+ (double)minimalTabDividerProminence;
...
+ (double)minimalTabStyleOutlineThickness;

...
DEFINE_STRING(tabColorMenuOptions, @"#fb6b62 #f6ac47 #f0dc4f #b5d749 #5fa3f8 #c18ed9 #787878 #4dccc0 #f87ca8 #7a85e0 #d96fc4 #c08a5a #6ad17a", SECTION_TABS @"Colors for tab color menu item.\nSpace delimited strings like #rrggbb or #rgb in sRGB color space. If the P3 color space is available, you can use strings like: color(p3 1 0.5 0.25)");
...
DEFINE_FLOAT(badgeMaxPointSize, 100, SECTION_BADGE @"Default maximum font point size for the badge\nThe badge auto-sizes to fit the available space; this caps how large it can grow. Used when a profile does not have its own setting.");
